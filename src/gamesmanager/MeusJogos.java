 ...
 * @author victor
 */
public class MeusJogos extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MeusJogos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
